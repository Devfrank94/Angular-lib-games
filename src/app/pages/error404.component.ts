  ...
  template: `
    ...
    <div class="flex flex-col bg-base-300 rounded-lg shadow-md p-5">
      <div class="text-center flex-1">
        <!-- Error Icon -->
        <div class="my-8">
          <div class="w-32 h-32 mx-auto mb-6 bg-error/10 rounded-full flex-center-center">
          ...
          <h1 class="text-8xl font-bold text-error mb-4">404</h1>
        ...
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
          <button
            class="btn bg-accent text-white btn-lg" routerLink="/home">
          ...
          <button
            class="btn btn-outline btn-lg" (click)="goBack()">
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="mt-8 pt-6 border-t border-base-content/10">
          <p class="text-sm text-base-content/60 mb-4">Oppure vai direttamente a:</p>
