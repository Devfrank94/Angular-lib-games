    ...
    <div class="card bg-base-300 shadow-xl rounded-lg">
      ...
      <div class="card-body p-5 lg:p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          ...
          <div class="tabs tabs-lg tabs-box my-4 flex justify-center max-w-8xl mx-auto">
            <label class="tab">
              <input type="radio" name="game_detail_tabs" (change)="showAchievements.set(true)" />
            ...
            <label class="tab">
              <input type="radio" name="game_detail_tabs" (change)="showTrailers.set(true)" />
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="size-4 me-2">
            ...
            <label class="tab">
              <input type="radio" name="game_detail_tabs" (change)="showScreenshots.set(true)" />
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="size-4 me-2">
